...
begin
  ...
  lValues.CommaText := Field.SearchExpression;
...
begin
  ...
  if not(Field.ShowAllValues) then
    begin
      lValues := TStringList.Create;
      lValues.Add(DateTimeToStr(FDateTimePicker1.Date));
      lValues.Add(DateTimeToStr(FDateTimePicker2.Date));
      Field.SearchExpression := lValues.CommaText;
      lValues.Free;
    end;
