...
{Necessary for Delphi 2005 and 2006.  Remove "x" if you are using Indy 9.}
{x$DEFINE Indy9}

{Necessary for Delphi 6 and 7.  Remove "x" if you are using Indy 10.}
{x$DEFINE Indy10}
...
uses
  ...
  {$IFNDEF Indy10}
    {$IFDEF Delphi9}
      {$IFDEF Indy9}
      ppSMTPIndy9;  //Include Indy Support
      {$ELSE}
      ppSMTPIndy10;
      {$ENDIF}
    {$ELSE}
