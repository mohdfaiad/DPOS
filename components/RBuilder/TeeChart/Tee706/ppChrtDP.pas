...
{------------------------------------------------------------------------------}
{ TppDPTeeChartControl.CreateParams }

procedure TppDPTeeChartControl.CreateParams(var Params: TCreateParams);
begin
...
{------------------------------------------------------------------------------}
{ TppDPTeeChartControl.GetChildOwner }

function TppDPTeeChartControl.GetChildOwner: TComponent;
begin
  Result := Self;
