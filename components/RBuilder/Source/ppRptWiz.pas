...
type
  ...
  TppLayoutFactory = class
    ...
    class function DataTypeToComponentClass(aDataType: TppDataType): TComponentClass;  virtual;
...
class function TppLayoutFactory.DataTypeToComponentClass(aDataType: TppDataType): TComponentClass;
begin
...
begin
  ...
  lComponentClass := gcLayoutFactory.DataTypeToComponentClass(aField.DataType);
...
begin
  ...
  for liField := 0 to FSelectedFields.Count - 1 do
    begin
      ...
      {get the component class based on the data type}
      lComponentClass := gcLayoutFactory.DataTypeToComponentClass(lField.DataType);
