...
uses
  Windows, Classes, Graphics, ExtCtrls, SysUtils, Forms, Controls, SyncObjs,
  ppComm, ppForms, ppTypes, ppUtils, ppPrintr, ppRTTI, ppRelatv;
...
{******************************************************************************}
  ...
  TppPage = class(TppRelative)
    ...
    public
      ...
      procedure Clear;
      function EqualTo(aPage: TppPage): Boolean;
  ...
  for liCommand := 0 to liCommands - 1 do
    begin
      ...
      if (lDrawCommandClass <> nil) then
        begin
          lTargetDrawCommand := lDrawCommandClass.Create(Self);
