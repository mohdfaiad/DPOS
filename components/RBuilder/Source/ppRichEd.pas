...
begin
  ...
  TppDisplayFormat.GetDisplayFormats(lDataType, lbxDisplayFormats.Items);
...
begin
  ...
  try
    ...
    FToolbar.Bullets.Checked := Boolean(Numbering);
...
begin
  ...
  FBullets := AddButton();
  FBullets.ImageIndex := ToolImageList.AddIcon('PPJUSTIFY');
