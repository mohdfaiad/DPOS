...
begin
  ...
  if (lReport.Columns <= 1) then
    begin
      ...
      FMinHeight := Trunc(ppFromMMThousandths(100542, utScreenPixels, pprtVertical, nil));
    ...
    begin
      FMinHeight := Trunc(ppFromMMThousandths(110067, utScreenPixels, pprtVertical, nil));
