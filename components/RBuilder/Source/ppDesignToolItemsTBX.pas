...
type
 ...
 // forward declaration
  ...
  {TppColorPalette}
  TppColorPalette = class(TppDesignToolPalette)
  private
    ...
    procedure ehColorButton_Click(Sender: TObject);
    procedure ehMoreColorsButton_Click(Sender: TObject);
...
constructor TppColorPalette.Create(aParent: TppTBXSubmenuItem);
begin
...
procedure TppColorPalette.ehColorButton_Click(Sender: TObject);
begin
...
procedure TppColorPalette.ehMoreColorsButton_Click(Sender: TObject);
var
  lColor: TColor;
begin
...
begin
  ...
  FTBXPalette := TppTBXToolPalette.Create(nil);
...
begin
  ...
  for liCol := 0 to 2 do
    for liRow := 0 to 2 do
     ...
     if cAnchors[liCol, liRow] = aAnchors then
      FTBXPalette.SelectedCell := Point(liRow, liCol);
