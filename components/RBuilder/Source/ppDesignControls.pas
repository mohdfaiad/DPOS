...
begin
  ...
  FWalkieTalkie.EventNotifies := [ciComponentBoundsChanged,
                                  ...
                                  ciComponentBringToFront,
                                  ciComponentSendToBack,
...
begin
  ...
  if (aCommunicator = FComponent) then
    if (aEventID = ciComponentBoundsChanged) then
      ...
      Invalidate
    else if (aEventID = ciComponentBringToFront) then
      BringToFront
    else if (aEventID = ciComponentSendToBack) then
      SendToBack
...
begin
  ...
  for liOffset := 0 to liLineWidth do
    begin
      ...
      if bpRight in lBorderPositions then
        begin
          ...
          aCanvas.LineTo(liRight - liOffset, liBottom);
        end;
...
begin
  ...
  if (FBand <> nil) then
    begin
      ...
      Band.Resize;                      {this will set the width}
      Visible      := True;
