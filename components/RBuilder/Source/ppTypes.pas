...
{******************************************************************************}
  ...
  TppCollationType = (ctANSI, ctASCII, ctVariant);
//  TppCollationType = (ctANSI, ctANSI_StringSort, ctASCII, ctVariant);
  ...
  TppBarCodeType = (bcUPC_A, bcUPC_E, bcEAN_13, bcEAN_8, bcInt2of5, bcCode128, bcCode39, bcPostnet, bcFIM, bcCodabar, bcMSI);
  ...
  //TppNullCollationType = (ncMSSQLServer, ncMSAccess, ncLowValue, ncHighValue);

  TppDatabaseType = (dtAdvantage, dtInterBase, dtMSAccess, dtMSSQLServer,
                     dtSybaseASE, dtSybaseASA, dtOracle, dtParadox, dtDBISAM, dtFlashFiler, dtMySQL, dtApollo, dtPostgreSQL, dtNexusDB, dtOther);
  ...
  TppDataEditType = (ppemAll, ppemPreview, ppemTables, ppemFields, ppemCalcs, ppemGroup, ppemSearch, ppemSort, ppemLink, ppemText);
  ...
  TppShowComponent = (scLabel, scMemo, scRichText, scCalc, scImage,
                      ...
                      scSystemVariable, scVariable, scPageBreak, sc2DBarCode, scDB2DBarCode);
