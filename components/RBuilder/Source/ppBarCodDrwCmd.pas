...
begin
  ...
  try
    lBitmap.Width  := DrawRight;
    lBitmap.Height := DrawBottom;
...
//    lScreenDevice.Canvas.Brush.Color := clRed;
//    lScreenDevice.Canvas.FrameRect(DrawRect);
        ...
        begin
          ...
          while (liX <= liDataBits) do
            begin
              ...
              if (lAbsX <= FPortraitWidth) and (lChar in ['1','2']) then
