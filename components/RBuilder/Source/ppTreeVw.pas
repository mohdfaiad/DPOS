...
uses
   Windows, CommCtrl, SysUtils, Controls, ComCtrls, Classes, Graphics, ExtCtrls, Menus, Messages,  StdCtrls, Forms, Dialogs,
   ppComm, ppClass, ppBands, ppCmpReg, ppTypes, ppUtils, ppSubRpt, ppReport,
   ppRegion, ppMetaBitmap, ppCtrls, ppDB,
   ppTBXPanel;
...
begin
  ...
  if (lsHelpFile <> '') and (lsDelphiPath <> '') then
    lsHelpFile := lsDelphiPath + '\Help\' + lsHelpFile;
