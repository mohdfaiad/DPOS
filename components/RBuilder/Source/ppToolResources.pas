...
const
 ...
 { cNudgeHints: array [0..3] of String =
  ...
  cZOrderNames: array [0..1] of string = ('BringToFront', 'SendToBack');

  cZOrderResNames: array [0..1] of string = ('PPBRINGTOFRONT', 'PPSENDTOBACK');

  cZOrderHints: array [0..1] of Integer = (161, 177);
