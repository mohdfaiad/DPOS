...
begin
  ...
  {Warn the user if an overwrite is about to occur.}
  else if ((AllowPrintToFile) or (AllowPrintToArchive)) and (cbxPrintToFile.Checked) and (FileExists(edtPrintToFileName.Text)) then
    begin
      Beep;
  ...
  if (ModalResult = mrOK) then
    begin
      ...
      if((AllowPrintToFile) or (AllowPrintToArchive)) and (cbxPrintToFile.Checked) then
        begin
          {validate filename and validate the extension}
          ValidateFileName;
