...
type
  ...
  TppStCustom2DBarcode = class(TGraphicControl)
    ...
    public
      ...
      procedure PaintToPrinterCanvasRes (ACanvas : TCanvas; Position : TPoint; ResX : Integer; ResY : Integer);
      ...
      procedure RenderToResolution (var OutBitmap : TBitmap; ResX : Integer; ResY : Integer; var SizeX : Integer; var SizeY : Integer); virtual; abstract;
  ...
  TppStPDF417Barcode = class(TppStCustom2DBarcode)
    ...
    public
      ...
      procedure RenderToResolution (var OutBitmap : TBitmap; ResX : Integer; ResY : Integer; var SizeX : Integer; var SizeY : Integer); override;
...
procedure TppStCustom2DBarcode.CopyToClipboardRes (ResX : Integer;
                                                 ResY : Integer);
var
  MetaFile       : TMetaFile;
...
procedure TppStCustom2DBarcode.GenerateBarcodeBitmap (BCWidth  : Integer;
                                                    BCHeight : Integer);
var
  TextHeight    : Integer;
  TextWidth     : Integer;
...
begin
  ...
  //FBitmap.Width := BarCodeWidth;    {Added Digital Metaphors 02/21/2006}
  //FBitmap.Height := BarCodeHeight + TopOffset + BottomOffset + (QuietZone*2);
...
procedure TppStCustom2DBarcode.PaintToCanvas (ACanvas  : TCanvas;
                                            Position : TPoint);
begin
  PaintToDC (ACanvas.Handle, Position);
end;

procedure TppStCustom2DBarcode.PaintToCanvasRes (ACanvas  : TCanvas;
                                               Position : TPoint;
                                               ResX     : Integer;
                                               ResY     : Integer);
begin
...
procedure TppStCustom2DBarcode.PaintToCanvasSize (ACanvas : TCanvas;
                                                X, Y, H : Double);
var
...
procedure TppStCustom2DBarcode.PaintToDC (DC : hDC; Position : TPoint);
var
  NewResX : Integer;
  NewResY : Integer;
...
procedure TppStCustom2DBarcode.PaintToDCRes (DC : hDC; Position : TPoint;
...
procedure TppStCustom2DBarcode.PaintToPrinterCanvas (ACanvas  : TCanvas;
                                                   Position : TPoint);
begin
  PaintToPrinterDC (ACanvas.Handle, Position);
end;

procedure TppStCustom2DBarcode.PaintToPrinterCanvasRes (ACanvas  : TCanvas;
                                                      Position : TPoint;
                                                      ResX     : Integer;
                                                      ResY     : Integer);
begin
...
procedure TppStCustom2DBarcode.PaintToPrinterCanvasSize (ACanvas : TCanvas;
                                                       X, Y, H : Double);
var
  PixelsPerInchX : Integer;
  PixelsPerInchY : Integer;
...
procedure TppStCustom2DBarcode.PaintToPrinterDC (DC : hDC; Position : TPoint);
var
  NewResX : Integer;
  NewResY : Integer;
...
procedure TppStCustom2DBarcode.PaintToPrinterDCRes (DC       : hDC;
                                                  Position : TPoint;
                                                  ResX     : Integer;
                                                  ResY     : Integer);
var
...
procedure TppStCustom2DBarcode.SaveToFileRes (const FileName : string;
                                            ResX : Integer; ResY : Integer);
var
  RenderBmp : TBitmap;
  SizeX     : Integer;
...
procedure TppStPDF417Barcode.RenderToResolution (var OutBitmap : TBitmap;
                                               ResX          : Integer;
                                               ResY          : Integer;
                                               var SizeX     : Integer;
                                               var SizeY     : Integer);
...
begin
  ...
  try
    if (ResX <> 0) and (ResY <> 0) then begin
      ...
      FBarHeight := Trunc (FBarHeight * MultY);
...
procedure TppStMaxiCodeBarcode.RenderToResolution (var OutBitmap : TBitmap;
                                                 ResX          : Integer;
                                                 ResY          : Integer;
                                                 var SizeX     : Integer;
                                                 var SizeY     : Integer);
