...
{------------------------------------------------------------------------------}
{ daBuildSQLFunctionList }

procedure daBuildSQLFunctionList(aList: TStrings);
begin
...
end; {procedure, daBuildSQLFunctionList}
...
begin
  ...
  while (liIndex < lFunctions.Count) and (liPosition = 0) do
    begin
      ...
      liPosition := Pos(lsFunction, aString);
