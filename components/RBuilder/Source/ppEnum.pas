...
uses
  Classes, TypInfo, SysUtils, Graphics, ExtCtrls, Printers, ppUtils, ppTypes;

  function raIsEnumValue(aWord: String; var aTypeName: String; var aValue: Byte): Boolean;
  function raEnumNameForValue(const aTypeName: String; aValue: Byte): String;
...
begin
  ...
  if (liIndex <> -1) then
    begin
      ...
      aValue := ppGetEnumStringAsByte(lTypeInfo, aWord);
