...
type
  ...
  TppItemOptionType = (ioAllowDesign, ioAllowNew, ioAllowDelete, ioAllowRename, ioAllowMove);
...
const
  ...
  cDefaultItemOptions = [ioAllowDesign, ioAllowNew, ioAllowRename, ioAllowDelete, ioAllowMove];
...
begin
  ...
  FPrint.Hint        := ppLoadStr(136);
  FPrintPreview.Hint := ppLoadStr(576);
  FErase.Hint        := ppLoadStr(124);
  FList.Hint         := ppLoadStr(510);
  FDetails.Hint      := ppLoadStr(508);
