...
type
  ...
  protected
    ...
    procedure UpdateWorkspaceViewColors;
...
{------------------------------------------------------------------------------}
{ TppDesignToolManager.UpdateWorkspaceViewColors}

procedure TppDesignToolManager.UpdateWorkspaceViewColors;
var
  lColor: TColor;
begin
  ...
  if (DesignControllers <> nil) then
    DesignControllers.WorkspaceView.SetRulerColor(lColor);
...
begin
  ...
  // subscrive to theme change notification
...
{------------------------------------------------------------------------------}
{ TppDesignToolManager.TBXSysCommand}

procedure TppDesignToolManager.TBXSysCommand(var Message: TMessage);
begin
