...
begin
  ...
  try
    ...
    if (Designer <> nil) then
      Designer.Form.LayoutManager.DocumentController.UpdateMRU(FReport.Template);
...
begin
  ...
  FItemTemplatePipeline.SetFieldValue(FItemFieldNames.Modified, Now);
...
begin
  ...
  if lbUpdateFolder and (LocateItemRecord(aItemName, aItemType, aFolderId)) then
    begin
      ...
      if FRecyclingItems then
        FItemPipeline.SetFieldValue(FItemFieldNames.Deleted, Now)
      else
