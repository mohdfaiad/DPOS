...
begin
  ...
  lsCaption := FTabSet.Tabs[aCurIndex].Caption;
  liImageIndex :=  FTabSet.Tabs[aCurIndex].ImageIndex;

  FTabSet.Tabs[aCurIndex].Caption := FTabSet.Tabs[aNewIndex].Caption;
  FTabSet.Tabs[aCurIndex].ImageIndex := FTabSet.Tabs[aNewIndex].ImageIndex;

  FTabSet.Tabs[aNewIndex].Caption := lsCaption;
  FTabSet.Tabs[aNewIndex].ImageIndex := liImageIndex;

  FPageList.Pages.Move(aCurIndex, aNewIndex);
