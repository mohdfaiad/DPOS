...
begin
  {strip off the ($WINSYS) prefix, if present}
  aStorageName := StringReplace(aStorageName, cWinSys, '', [rfReplaceAll, rfIgnoreCase]);

  Result := TIniFile.Create(aStorageName)
