...
type
  ...
  public
    ...
    property Report: TppCustomReport read FReport write FReport;
  end;
  ...
  private
    ...
    FIsValid: Boolean;
  public
    property Component: TppComponent read FComponent write FComponent;
...
begin
  ...
  case aEventID of
    ...
    RM_COMPONENTNAMECHANGE:
      if (aEventParams is TppCustomReport) then
    ...
    RM_REPORTDESTROY:
      begin
        ...
        if (aEventParams is TppReport) then
...
{TODO    RM_SETREPORT: OnSetReport(Self, aOParam);
    ...
    RM_REPORTSAVESTART:  RMReportSaveStart(aWParam, aOParam);
 }
