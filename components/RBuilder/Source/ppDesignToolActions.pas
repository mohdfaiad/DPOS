...
type
  ...
  private
    ...
    FormatActions: TppFormatActionList;
  ...
  TppZOrderType = (zoBringToFront, zoSendToBack);
...
begin
  ...
  FormatActions := TppFormatActionList.Create(nil);
  ...
  FActionLists.Add(FormatActions);
...
begin
  ...
  FActionLists.Remove(FormatActions);
...
var
  ...
  lComboBoxAction: TppDefaultPropValueListAction;
  lComboBoxAction2: TppDefaultPropValueList2Action;
begin
  ...
  lComboBoxAction := TppDefaultPropValueListAction.Create(nil);
  lComboBoxAction.Name := 'ComboBox'; // do not localize
  lComboBoxAction.ActionList := Self;
  lComboBoxAction.Enabled := False;
  lComboBoxAction.Visible := False;

  lComboBoxAction2 := TppDefaultPropValueList2Action.Create(nil);
  lComboBoxAction2.Name := 'ComboBox2'; // do not localize
  lComboBoxAction2.ActionList := Self;
  lComboBoxAction2.Enabled := False;
  lComboBoxAction2.Visible := False;
...
begin
  ...
  if (FZOrderType = zoBringToFront) then
...
begin
  ...
  lZOrderAction.Name := 'BringToFront';
  lZOrderAction.ZOrderType := zoBringToFront;
  lZOrderAction.ActionList := Self;

  // send to back
  lZOrderAction := TppZOrderAction.Create(nil);
  lZOrderAction.Name := 'SendToBack';
  lZOrderAction.ZOrderType := zoSendToBack;
  lZOrderAction.ActionList := Self;
...
begin
  ...
  if (FDefaultComponent <> nil) then
    begin
      ...
      if (liIndex >= 0) then
        FDefaultComponent.DataPipeline := TppDataPipeline(Items.Objects[liIndex]);
    end;
