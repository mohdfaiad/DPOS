...
{$ENDIF}
  ...
  Windows, Classes, Graphics, ExtCtrls, SysUtils, Forms, Controls, Dialogs,
  Menus, Chart, DBChart, TeEngine, TeExport,
  ppClass, ppCtrls, ppTypes, ppUtils, ppDevice, ppDrwCmd, ppChrt,
  ppChrtUI;
