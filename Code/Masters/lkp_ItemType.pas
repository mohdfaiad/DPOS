...
procedure TfmItemType.BtnOpenClick(Sender: TObject);
begin
  SDS_Header.Close;
  SDS_Header.Open;
...
procedure TfmItemType.btnEditClick(Sender: TObject);
begin
  SDS_Header.Edit;
...
procedure TfmItemType.btnSaveClick(Sender: TObject);
Var IsDuplicated : Boolean;
begin
  If SDS_HeaderItemTypeCode.AsString = '' Then
  Begin
  ...
  If (SDS_HeaderItemTypeNameAr.AsString = '') AND (SDS_HeaderItemTypeNameEn.AsString = '')  Then
  Begin
     ShowMessage('ÌÃ»  ÕœÌœ «·«”„ ﬁ»· «·Õ›Ÿ');
     edtName.SetFocus;
     Exit;
  ...
  IsDuplicated := RepeatedKey('tbl_ItemType', ' ItemTypeCode = ''' + SDS_HeaderItemTypeCode.AsString + '''  ');
...
procedure TfmItemType.btnDeleteClick(Sender: TObject);
Var
  buttonSelected : Integer;
begin
  try
...
procedure TfmItemType.btnAddClick(Sender: TObject);
begin
  SDS_Header.Append;
  btnEdit.Enabled := False;
  BtnOpen.Enabled := False;
